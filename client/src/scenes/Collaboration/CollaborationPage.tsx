...
export const CollaborationPage: React.FC = () => {
  ...
  const { firstName } = JSON.parse(
    localStorage.getItem("shippingAddress") || "false"
  ) as { firstName: string }
  ...
  return (
    <>
      <div className='container mt-8'>
        ...
        <div className='mt-8'>
          <Typography>
            Special offer. <br/> We invite interior designers, art dealers, art stores,
            galleries, influencers, and everyone connected with art and
            interested in mutually beneficial cooperation to join our team. We
            are pleased to offer exclusive deals and individual promo codes to
            our partners. Just leave your contact information and tell us a
            little bit about yourself so we can get in touch and discuss the
            details of our collaboration. We are waiting for your message and
