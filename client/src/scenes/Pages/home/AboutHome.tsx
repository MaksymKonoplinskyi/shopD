...
export const AboutHome: React.FC = () => {
  ...
  const aboutHomeInfo = useAppSelector(state => state.home.aboutHomeInfo)
  ...
  return (
    <>
      <div className='flex justify-between gap-12'>
        ...
        <div className='w-2/3'>
          <img src={aboutHomeInfo.photoUrl} alt={aboutHomeInfo.title} className='bg-gray-200 object-contain w-full h-full' />
        </div>
      </div>
    </>
  )
