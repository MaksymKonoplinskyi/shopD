...
export default function Cart() {
  ...
  const totalPriceWithDiscount = (totalPrice * (100 - promo.discount)) / 100
            ...
            <div className='pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'>
              ...
              >
                    ...
                    <div className='border-t border-gray-200 px-4 py-6 sm:px-6'>
                      {promo.isCorrect ? (
                        <div className='flex justify-between text-base font-medium text-gray-900'>
                          ...
                          <p>
                            Subtotal with discount: ${totalPriceWithDiscount}
                          </p>
                        </div>
                      ) : (
                        <div className='flex justify-between text-base font-medium text-gray-900'>
                      ...
                      {/* <p className='mt-0.5 text-sm text-gray-500 mb-4'>
                        After receiving the order, we will calculate the cost of
                        shipping and send you the final invoice with shipping
                        price by e-mail.
                      </p> */}
                      {/* <div
                ...
                text-white w-full cursor-pointer
                 text-lg tracking-widest font-[900] 
                  border border-black
                hover:bg-gray-700  
                h-14'
                        onClick={() => {
